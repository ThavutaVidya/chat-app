    ...
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      ...
      <div className=" absolute border-0 left-0 right-0 flex items-center gap-3 p-3 ">
        <div className="flex-1 flex items-center px-3 rounded-full bg-gray-100/12">
          <input onChange={(e)=>setInput(e.target.value)} value={input} onKeyDown={(e)=> e.key === "Enter" ? handleSendMessage(e) : null} type="text" placeholder="Send a message" className="flex-1 text-sm p-3 border-none outline-none text-white rounded-lg placeholder-gray-400"/>
