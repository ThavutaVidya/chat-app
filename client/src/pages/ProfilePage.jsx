    ...
    <div className='min-h-screen bg-cover bg-no-repeat flex justify-center items-center'>
      <div className='w-5/6 max-w-2xl backdrop-blur-2xl text-gray-300 border-2 border-gray-600 flex items-center justify-between max-sm:flex-col-reverse'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1 '>
          ...
          <input onChange={(e)=>setName(e.target.value)} value={name} type="text" placeholder='Your name' className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500  ' />
          ...
          <button type='submit' className='bg-gradient-to-r from-purple-400 to-violet-600 text-white  rounded-full text-lg p-2 cursor-pointer'>Save</button>
        </form>
