...
const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-center  backdrop-blur-2xl flex justify-center items-center gap-8 sm:justify-evenly max-sm:flex-col'>
      {/* -----left----- */}
      <img src={assets.logo_big} alt="" className='w-[min(30vw,250px)]' />
      {/* -----right----- */}
      <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white p-6 border-gray-500 flex flex-col gap-6 rounded-lg shadow-lg'>
      <h2 className='font-medium text-2xl flex justify-between items-center '>
        {currState}
        {isDataSubmitted && <img className='w-5 cursor-pointer' src={assets.arrow_icon} onClick={()=>setIsDataSubmitted(false)}/>}
